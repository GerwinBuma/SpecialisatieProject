// ======================================================================
// ADC_DMA_UART.v generated from TopDesign.cysch
// 01/21/2022 at 11:27
...
module ADC_SAR_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("db03643a-4063-4b4c-ba68-66d900e948fa/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module USBFS_v3_20_4 (
	...
	cy_psoc3_pins_v1_10
		#(.id("2befc057-51af-4398-95e8-09f61db47d75/8b77a6c4-10a0-4390-971c-672353e2a49c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2befc057-51af-4398-95e8-09f61db47d75/618a72fc-5ddd-4df5-958f-a3d55102db42"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("31db2e0f-e5bc-4278-a3f5-73f5cb2ff653"),
