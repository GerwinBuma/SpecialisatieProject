...
void pwm_int_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)pwm_int__INTC_NUMBER] = address;
}
...
cyisraddress pwm_int_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)pwm_int__INTC_NUMBER];
}
