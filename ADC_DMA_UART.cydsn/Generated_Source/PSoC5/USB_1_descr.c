...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USB_1_DEVICE0_CONFIGURATION0_DESCR[25u] = {
...
*********************************************************************/
const uint8 CYCODE USB_1_STRING_DESCRIPTORS[49u] = {
/*********************************************************************
...
*********************************************************************/
const T_USB_1_EP_SETTINGS_BLOCK CYCODE USB_1_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[1u] = {
/* IFC  ALT    EPAddr bmAttr MaxPktSize Class ********************/
{0x00u, 0x00u, 0x81u, 0x02u, 0x0040u,   0xFFu}
};
const uint8 CYCODE USB_1_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[1u] = {
0xFFu
};
/*********************************************************************
...
*********************************************************************/
const T_USB_1_LUT CYCODE USB_1_DEVICE0_CONFIGURATION0_TABLE[4u] = {
    {0x01u,     &USB_1_DEVICE0_CONFIGURATION0_DESCR},
    {0x01u,     &USB_1_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
